...
const suinova_create_plasmic_app_1 = require("suinova-create-plasmic-app");
...
class PlasmicAction {
    ...
    init() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (0, suinova_create_plasmic_app_1.setMetadata)({
                source: "plasmic-action",
            });
            const relTmpDir = "tmp-cpa";
            yield (0, suinova_create_plasmic_app_1.create)({
    ...
    sync() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, exec_1.exec)(`${pm.add} suinova-cli`, this.opts);
