...
const suinova_cli_1 = require("suinova-cli");
...
function create(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (projectApiToken) {
            ...
            const promise = (0, suinova_cli_1.auth)({
                host: "https://suinova.var-meta.com",
                check: true,
            })
                .catch(() => {
                return (0, suinova_cli_1.auth)({ host: "https://suinova.var-meta.com" });
            })
                .catch(() => {
                throw new Error("Failed to authenticate with SuiNova. Please run `npx suinova-cli auth` manually.");
            });
            yield promise;
        }
        ...
        if (scheme === "loader" && !projectApiToken) {
            projectApiToken = yield (0, suinova_cli_1.getProjectApiToken)(projectId);
            if (!projectApiToken) {
        ...
        yield (0, file_utils_1.updateViteFile)(resolvedProjectPath);
        // Generate routing code
        yield (0, file_utils_1.generateRoutingCode)(resolvedProjectPath);
        console.log("----------------------------------------");
 ...
 * can use it too
 */
exports.setMetadata = suinova_cli_1.setMetadataEnv;
