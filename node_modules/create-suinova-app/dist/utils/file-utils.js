...
function updateViteFile(projectPath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        configAppFileContent.replace(searchText, replaceText);
        yield fs_1.promises.writeFile(tsConfigAppFile, configAppFileContent);
        ...
        configNodeFileContent.replace(searchText, replaceText);
