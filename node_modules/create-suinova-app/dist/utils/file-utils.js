...
function updateViteFile(projectPath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log("🚀 ~ updateViteFile ~ configAppFileContent:", configAppFileContent);
        const replacedAppFileContent = configAppFileContent.replace(searchText, replaceText);
        console.log("🚀 ~ updateViteFile ~ replacedAppFileContent:", replacedAppFileContent);
        ...
        console.log("🚀 ~ updateViteFile ~ configNodeFileContent:", configNodeFileContent);
        const replacedNodeFileContent = configNodeFileContent.replace(searchText, replaceText);
        console.log("🚀 ~ updateViteFile ~ replacedNodeFileContent:", replacedNodeFileContent);
 ...
 * @returns
 */
function generateHomePage(componentAbsPath, indexAbsPath, projectPath, globalContextsAbsPath) {
    return __awaiter(this, void 0, void 0, function* () {
