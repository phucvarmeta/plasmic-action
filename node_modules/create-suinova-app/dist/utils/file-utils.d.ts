import type { PlasmicConfig } from "suinova-cli/dist/utils/config-utils";
...
export declare function extractComponentName(renderModuleFilePath: string): string;
export declare function extractRoutes(projectPath: string): Promise<{
    componentName: string;
    modulePath: string;
    path: string;
    importPath: string;
}[]>;
export declare function generateRoutingCode(projectPath: string): Promise<void>;
export declare function updateViteFile(projectPath: string): Promise<void>;
/**
 ...
 * @returns
 */
export declare function generateHomePage(componentAbsPath: string, indexAbsPath: string, projectPath: string, globalContextsAbsPath?: string): Promise<string>;
/**
