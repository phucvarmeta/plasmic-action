    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (projectApiToken) {
            ...
            const promise = (0, suinova_cli_1.auth)({
                ...
                .catch(() => {
                return (0, suinova_cli_1.auth)({ host: "https://studio.plasmic.app" });
            })
                .catch(() => {
                throw new Error("Failed to authenticate with Plasmic. Please run `npx suinova-cli@0.0.1 auth` manually.");
            });
            yield promise;
        }
