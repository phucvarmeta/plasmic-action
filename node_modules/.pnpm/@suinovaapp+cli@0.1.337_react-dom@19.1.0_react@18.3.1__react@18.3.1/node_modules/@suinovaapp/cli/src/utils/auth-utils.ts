...
export function getEnvAuth(): AuthConfig | undefined {
  const host = 'https://suinova.var-meta.com';
...
export async function getOrStartAuth(
  ...
  // Always return a valid auth config
  return {
    host: opts.host || DEFAULT_HOST,
    user: "bypass",
    token: "wTUnm5rucvjBcnM5i1P6bsoj2cFsjiYX0aRPZNRaEKKi7h6A013UNPInXmRyDEJ6IaBuvCll1WIGjTJc6eg"
  };
}
